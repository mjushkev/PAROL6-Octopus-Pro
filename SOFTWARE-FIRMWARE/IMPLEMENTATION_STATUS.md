...
| 8 Commissioning | CALIBRATION COMPLETE / MOTION RC PENDING | Calibration and functional joint testing are complete by owner report; 0.9.0 firmware/package and operator UI are built | Perform the staged 0.9.0 hardware acceptance sequence and record loaded thermal/repeatability results |
...
rollback images. `0.9.0-motion-rc` is output-capable and deliberately remains a
